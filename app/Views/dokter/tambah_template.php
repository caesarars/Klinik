            ...
            <form action="<?= base_url('dokter/insert_template/') ?>" method="POST">
                ...
                <div class="form-row justify-content-center pt-2">
                    <div class="form-group col-5">
                        ...
                        <textarea class="form-control border-2" id="assessment" name="assessment" rows="10" required></textarea>
                    </div>
                    <div class="col-sm-1">
                    </div>
                    <div class="form-group col-5">
                        <label class="fw-bold" style="color: 2269D2;" for="objective">OBJECTIVE</label>
                        <textarea class="form-control border-2" id="objective" name="objective" rows="10" required></textarea>
                        <br>
