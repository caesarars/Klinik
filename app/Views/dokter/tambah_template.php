    ...
    <div class="row w-auto me-4">
        ...
        <div class="col ms-2 bg-white">
            <div class="row pt-3 p-0 mt-3">
                <h5 class="font-weight-bold" style="color: B02525;">Tambah Template SOAP</h5>
            </div>
            <div class="row px-0">
                <div class="col-100">
            ...
            <form action="<?= base_url('dokter/insert_template/') ?>" method="POST">
                ...
                <div class="form-row justify-content-center pt-2">
                    <div class="form-group col-5">
                        ...
                        <textarea class="form-control border-2" id="subjective" name="subjective" rows="10"></textarea>
                        <br>
                        <label class="fw-bold" style="color: 2269D2;" for="assesment">ASSESMENT</label>
                        <textarea class="form-control border-2" id="assesment" name="assesment" rows="10"></textarea>
                    </div>
                    <div class="col-sm-1">
                    </div>
                    <div class="form-group col-5">
                        <label class="fw-bold" style="color: 2269D2;" for="objective">OBJECTIVE</label>
                        <textarea class="form-control border-2" id="objective" name="objective" rows="10"></textarea>
                        <br>
                        <label class="fw-bold" style="color: 2269D2;" for="planning">PLANNING</label>
                        <textarea class="form-control border-2" id="planning" name="planning" rows="10"></textarea>
                    </div>
                </div>
