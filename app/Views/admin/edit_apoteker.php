    ...
    <div class="row w-auto me-4">
        ...
        <div class="col bg-white py-3 ms-2">
            <div class="container">
                ...
                <form action="<?= base_url('Admin/update_apoteker/' . $apoteker['id']) ?>" method="POST">
                    ...
                    <div class="row form-group">
                        <p>Nama Lengkap</p>
                        <input type="text" class="form-control" name="nama" id="nama" autocomplete="off" value="<?= $apoteker['nama']; ?>">
                    </div>
                    <div class="row">
                        <p>NIK</p>
                        <input type="text" class="form-control" name="nik" id="nik" autocomplete="off" value="<?= $apoteker['nik']; ?>">
                    </div>
                    <div class="row">
                        <div class="col ps-0">
                            <p>Tempat Lahir</p>
                            <input type="text" class="form-control" name="tempatLahir" id="tempatLahir" autocomplete="off" value="<?= $apoteker['tempatLahir']; ?>">
                        </div>
                        <div class="col pe-0">
                            <p>Tanggal Lahir</p>
                            <input type="date" class="form-control" name="tanggalLahir" id="tanggalLahir" autocomplete="off" value="<?= $apoteker['tanggalLahir']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <p>Jenis Kelamin</p>
                    ...
                    <div class="row">
                        <p>Kewarganegaraan</p>
                        <input type="text" class="form-control" name="kewarganegaraan" id="kewarganegaraan" autocomplete="off" value="<?= $apoteker['kewarganegaraan']; ?>">
                    </div>
                    <div class="row">
                        <p>Agama</p>
                    ...
                    <div class="row">
                        <p>Golongan Darah</p>
                        <input type="text" class="form-control" name="golonganDarah" id="golonganDarah" autocomplete="off" value="<?= $apoteker['golonganDarah']; ?>">
                    </div>
                    <div class="row">
                        <p>Pendidikan Terakhir</p>
                        <input type="text" class="form-control" name="pendidikan" id="pendidikan" autocomplete="off" value="<?= $apoteker['pendidikan']; ?>">
                    </div>
                    <div class="row">
                        <p>Alamat</p>
                        <input type="text" class="form-control" name="alamat" id="alamat" autocomplete="off" value="<?= $apoteker['alamat']; ?>">
                    </div>
                    <div class="row">
                        <div class="col ps-0">
                            <p>Kelurahan</p>
                            <input type="text" class="form-control" name="kelurahan" id="kelurahan" autocomplete="off" value="<?= $apoteker['kelurahan']; ?>">
                        </div>
                        <div class="col">
                            <p>kecamatan</p>
                            <input type="text" class="form-control" name="kecamatan" id="kecamatan" autocomplete="off" value="<?= $apoteker['kecamatan']; ?>">
                        </div>
                        <div class="col pe-0">
                            <p>Kabupaten/Kota</p>
                            <input type="text" class="form-control" name="kabupaten" id="kabupaten" autocomplete="off" value="<?= $apoteker['kabupaten']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col ps-0">
                            <p>Provinsi</p>
                            <input type="text" class="form-control" name="provinsi" id="provinsi" autocomplete="off" value="<?= $apoteker['provinsi']; ?>">
                        </div>
                        <div class="col pe-0">
                            <p>Kode Pos</p>
                            <input type="text" class="form-control" name="kodePos" id="kodePos" autocomplete="off" value="<?= $apoteker['kodePos']; ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col ps-0">
                            <p>Nomor Telepon</p>
                            <input type="text" class="form-control" name="noTelp" id="noTelp" autocomplete="off" value="<?= $apoteker['noTelp']; ?>">
                        </div>
                        <div class="col">
                            <p>Nomor Handphone</p>
                            <input type="text" class="form-control" name="noHP" id="noHP" autocomplete="off" value="<?= $apoteker['noHP']; ?>">
                        </div>
                        <div class="col pe-0">
                            <p>Email</p>
                            <input type="text" class="form-control" name="email" id="email" autocomplete="off" value="<?= $apoteker['email']; ?>">
                        </div>
                    </div>
