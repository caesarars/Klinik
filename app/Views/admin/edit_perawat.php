    ...
    <div class="row w-auto me-4">
        ...
        <div class="col bg-white py-3 ms-2">
            <div class="container">
                ...
                <form action="<?= base_url('Admin/update_perawat/' . $perawat['id']) ?>" method="POST">
                    ...
                    <div class="row">
                        <p>Umur</p>
                        <input type="text" class="form-control" name="umur" id="umur" autocomplete="off" value="<?= $perawat['umur']; ?>">
                    </div>
                    <div class="row">
