        ...
        <div class="col bg-white py-3 ms-2">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-4">
                        <a href="<?= base_url('admin/tambah_apoteker') ?>" class="btn-primary p-2">
                    ...
                    <div class="col-6 text-right pe-0">
                        <div class="search">
                            <form action="<?= base_url('admin/search_apoteker/') ?>" method="POST">
                ...
                <div class="table100 ver1 m-b-110 mt-3">
                    ...
                    <div class="table100-body js-pscroll">
                        <table>
                            ...
                            ?>
                                <tbody>
                                    <tr class="row100 body" data-href='<?= base_url('admin/data_apoteker/' . $data['id']) ?>'>
                                        ...
                                        <td class="cell100 column5">
                                            <a href="<?= base_url('admin/edit_apoteker/' . $data['id']) ?>">
                                                <img src="<?= base_url('images/edit-blue.png') ?>" class="img-thumbnail" style="height: 30px;" alt="">
                                            </a>
                                            <a class="btn-delete" href="<?= base_url('admin/delete_apoteker/' . $data['id']) ?>">
