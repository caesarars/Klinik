        ...
        <div class="col bg-white py-3 ms-2">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-3">
                        <a href="<?= base_url('pemilik/tambah_dokter') ?>" class="btn-primary p-2">
                    ...
                    <div class="col-6 text-right pe-0">
                        <div class="search">
                            <form action="<?= base_url('pemilik/search_dokter/') ?>" method="POST">
                                ...
                                ?>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell column5">
                                            ...
                                            <a class="btn-delete" href="<?= base_url('pemilik/delete_dokter/' . $dok['id']) ?>">
