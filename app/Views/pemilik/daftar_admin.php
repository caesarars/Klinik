    ...
    <div class="row w-auto me-4">
        <div class="col-3 ps-0 bg-white me-2 p-2">
            <div class="list-group">
                ...
                <a href="<?= base_url('pemilik/export_excel') ?>" class="list-group-item list-group-item-action fw-bold">
                    <img src="<?= base_url('images/doctor-blue.png') ?>" class="img-thumbnail" style="height: 30px;" alt="">
                    Export Excel
                </a>
            </div>
        ...
        <div class="col bg-white py-3 ms-2">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-4">
                        <a href="<?= base_url('pemilik/tambah_admin') ?>" class="btn-primary p-2">
                    ...
                    <div class="col-6 text-right pe-0">
                        <div class="search">
                            <form action="<?= base_url('pemilik/search_admin/') ?>" method="POST">
                                ...
                                ?>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell column5">
                                            ...
                                            <a class="btn-delete" href="<?= base_url('pemilik/delete_admin/' . $adm['id']) ?>">
